...
class EditPhoneNumberOtpCodePage extends BasePage {

  private readonly otpCodeTitleElement = "edit-phone-otp-code-title";
...
export default new EditPhoneNumberOtpCodePage();